...
public class ProductoIterable implements Iterable<Map.Entry<String, Producto>>, Serializable {
     ...
     * @throws IllegalArgumentException si el producto ya está registrado.
     */
    public void agregar(Producto producto) {
        String codigo = producto.getCodigo();
        if (diccionario.containsKey(codigo)) {
            throw new IllegalArgumentException("El producto con el código '" + codigo + "' ya está registrado.");
        }
        diccionario.put(codigo, producto);
    }
    ...
    public Producto getProducto(String identificador) {
        if (!diccionario.containsKey(identificador)) {
            throw new IllegalArgumentException("El producto con el código '" + identificador + "' no está registrado.");
        }
